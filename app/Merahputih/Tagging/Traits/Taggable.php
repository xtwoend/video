<?php namespace Merahputih\Tagging\Traits;

use Illuminate\Support\Str;
use Merahputih\Tagging\Models\Tag;
use Merahputih\Tagging\Models\Tagged;
...
trait Taggable {
	...
	public function tagged() {
		return $this->morphMany('Merahputih\Tagging\Models\Tagged', 'taggable');
	}
	...
	public function scopeWithAllTags($query, $tagNames) {
		...
		$tagNames = array_map('Merahputih\Tagging\Models\Tag::slug', $tagNames);
