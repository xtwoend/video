          ...
          <div class="main-content col-xs-12 col-md-8 col-md-offset-2">
            <div class="region">
                  ...
                  <div class="theme-comments">
                    ...
                    <form class="form-horizontal" method="post" role="form" action="{{ route('licenses.store') }}">                  
                      
                      <div class="form-group">
                        <div class="col-xs-12">
                          <input type="text" class="form-control" rows="8" id="license" name="license" placeholder="License">
                        </div> <!-- /col-xs-12 -->
                      </div> <!-- /form-group -->
