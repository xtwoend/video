          ...
          <div class="main-content col-xs-12 col-md-8 col-md-offset-2">
            <div class="region">
                  ...
                  <div class="theme-comments">
                    ...
                    <h4 class="theme-comments-title">Category</h4>
                    
                    <form class="form-horizontal" method="post" role="form" action="{{ route('categories.store') }}">                  
                      
                      <div class="form-group">
                        <div class="col-xs-12">
                          <textarea class="form-control" rows="8" id="comment" name="category" placeholder="Comment"></textarea>
                        </div> <!-- /col-xs-12 -->
                      </div> <!-- /form-group -->
