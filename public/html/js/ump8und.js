...
window.Typekit.config = {
  ...
  "f": "//use.typekit.net/c/18acbc/proxima-nova:i4:i7:n1:n3:n4:n7.b5x:N:2,b61:N:2,b5r:N:2,b5t:N:2,b5w:N:2,b60:N:2/{format}{/extras*}?",
  "fn": ["proxima-nova", ["i4", "i7", "n1", "n3", "n4", "n7"]],
  "k": "//use.typekit.net/{id}.js",
  "p": "//p.typekit.net/p.gif?s=1&k=ump8und&ht=tk&h={host}&f=139.140.171.175.176.5474&a=751041&_={_}",
  "w": "ump8und"
...
(function(window, document, undefined) {
  ...
  ka.prototype.parse = function() {
    ...
    C(this.e, /Presto\/([\d\w\.]+)/, 1), c = y(b), d = B(this), e = y(d), f = F(this.R), c.g !== k ? a = "Presto" : (-1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = C(this.e, /rv:([^\)]+)/, 1), c = y(b)), -1 != this.e.indexOf("Opera Mini/")) g = C(this.e, /Opera Mini\/([\d\.]+)/, 1),
    h = y(g),
    a = new z("OperaMini", h, g, a, c, b, A(this), e, d, f, new u(l, l, l));
    else {
  ...
  function B(a) {
    ...
    if (b = C(a.e, /(?:Linux|CrOS) ([^;)]+)/, 1)) for (var b = b.split(/\s/), c = 0; c < b.length; c += 1) if (/^[\d\._]+$/.test(b[c])) return b[c];
  ...
  function oa(a) {
    ...
    "BuiltinBrowser" == g ? p = "Unknown" : "Silk" == g ? p = C(a.e, /Silk\/([\d\._]+)/, 1) : "Chrome" == g ? p = C(a.e, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2) : -1 != a.e.indexOf("Version/") ? p = C(a.e, /Version\/([\d\.\w]+)/, 1) : "AdobeAIR" == g ? p = C(a.e, /AdobeAIR\/([\d\.]+)/, 1) : "Opera" == g ? p = C(a.e, /OPR\/([\d.]+)/, 1) : "PhantomJS" == g && (p = C(a.e, /PhantomJS\/([\d.]+)/, 1));
    h = y(p);
    M = "AdobeAIR" == g ? 2 < h.g || 2 == h.g && 5 <= h.o : "BlackBerry" == b ? 10 <= d.g : "Android" == b ? 2 < d.g || 2 == d.g && 1 < d.o : 526 <= f.g || 525 <= f.g && 13 <= f.o;
    return new z(g, h, p, "AppleWebKit", f, e, b, d, c, F(a.R), new u(M, 536 > f.g || 536 == f.g && 11 > f.o, "iPhone" == b || "iPad" == b || "iPod" == b || "Macintosh" == b))
  }
  function C(a, b, c) {
  ...
  var Ua = {
    ...
    Xa: "i"
      ...
      Va = {
      a: function(a, b) {
        return Oa(a) && S(a) || Qa(a) && (Ka(a, b) || U(a, b) && x(a.l, new v(4, 1))) || b.K && "Silk" === a.getName() && -1 === w(a.q, new v(2)) && (Ka(a, b) || T) || b.K && "Silk" === a.getName() && x(a.q, new v(2)) && U(a, b) && x(a.l, new v(4, 1)) || Na(a) && (Ja(a, b) || Ia(a, b)) || Ma(a) && (S(a) || V(a)) || Pa(a) && (S(a) || V(a)) || ("Chrome" === a.getName() && 1 === w(a.q, new v(4, 0, 249)) && -1 === w(a.q, new v(6)) || 0 === w(a.q, new v(4, 0, 249)) && (a.q.h === k || 4 <= a.q.h)) && (S(a) || V(a) || T(a)) || "Chrome" === a.getName() && x(a.q, new v(6)) && (Ja(a, b) || Ia(a, b)) || "AdobeAIR" === a.getName() && x(a.q, new v(2, 5)) && (Q(a) && a.l.g === k || V(a))
      },
      b: function(a) {
        return Ma(a) && T(a) || Oa(a) && T(a) || Pa(a) && T(a) || "AdobeAIR" === a.getName() && x(a.q, new v(2, 5)) && T(a)
      },
      d: function(a, b) {
        return "Chrome" === a.getName() && x(a.q, new v(6)) && (S(a) || V(a) || T(a) || U(a, b) || "CrOS" === a.m || b.U && "iPad" === a.m && x(a.l, new v(5)) || Ha(a, b) && x(a.l, new v(5))) || "Gecko" === a.B && 1 === w(a.F, new v(1, 9, 1)) && (S(a) || V(a) || T(a) || U(a, b)) || "Safari" === a.getName() && ("AppleWebKit" === a.B && x(a.F, new v(534, 50))) && (S(a) || T(a)) || Na(a) && (b.U && "iPad" === a.m && x(a.l, new v(5)) || Ha(a, b) && x(a.l, new v(5))) || "Opera" === a.getName() && x(a.q, new v(11, 10)) && (S(a) || V(a) || T(a) || U(a, b)) || "MSIE" === a.getName() && 9 <= a.S && (Q(a) && x(a.l, new v(6, 1)) || Q(a) && 0 === w(a.l, new v(6, 0))) || "MSIE" === a.getName() && b.ya && "Windows Phone" === a.m && x(a.l, new v(8)) || Qa(a) && b.ka && "BlackBerry" === a.m && x(a.l, new v(10))
      },
      f: function(a, b) {
        return Qa(a) && La(a, b) || b.K && "Silk" === a.getName() && x(a.q, new v(2)) && (La(a, b) || V(a))
      },
      i: function(a) {
        return "MSIE" === a.getName() && (x(a.q, new v(6, 0)) && (void 0 === a.S || 9 > a.S)) && S(a)
      }
      };
  ...
  X.prototype.collectFontFamilies = function(a, b) {
    if (this.t) for (var c = 0; c < this.v.length; c++) Ea(this.v[c], this.t, a, b)
  };
      ...
      if (d) {
        ...
        for (var f = new N(a.e, a.j, c, b.timeout), c = function(a, b, c) {
          for (var d = [], e = 0; e < a.length; e += 1) {
            var R = a[e];
            if (b[R]) for (var D = b[R], I = 0; I < D.length; I += 1) d.push(new J(R, D[I]));
            else d.push(new J(R))
          }
          f.fa(d, {}, k, c)
        }, d = 0; d < a.u.length; d++) e = a.u[d], e.supportsConfiguredBrowser() && (e.load(c, d == a.u.length - 1, a.la), e.performOptionalActions(window))
      } else ra(c);
      a.u = []
    }
  }
  ...
  var i;
  if (O.fn) for (i = 0; i < O.fn.length; i += 2) Z.v.push(new Da(O.fn[i], O.fn[i + 1]));
  if (O.c) for (i = 0; i < O.c.length; i += 2) Z.Q.push(new za);
  var nb;
